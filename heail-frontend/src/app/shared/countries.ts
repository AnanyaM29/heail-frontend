/** Shared country list — used to drive both the "Country" dropdown and the
 *  mobile "Country code" dropdown everywhere in the app, so they only need
 *  to be maintained in one place. `dial` includes the leading "+". */
